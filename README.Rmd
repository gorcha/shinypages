...
[![Codecov test coverage](https://codecov.io/gh/gorcha/shinypages/branch/main/graph/badge.svg)](https://app.codecov.io/gh/gorcha/shinypages?branch=main)
<!-- badges: end -->

shinypages is a simple multi-page router for Shiny applications, very much
inspired by Appsilon's [shiny.router](https://github.com/Appsilon/shiny.router).
